const elements = {
    ...
    scrollLinks: document.querySelectorAll(".navbarLinks, .footerLinks"),
    ...
    dropdownClick: document.querySelector(".dropdownClick"),
...
// Show dropdown
elements.dropdown.addEventListener("click", () => {
    elements.dropdownItems.classList.toggle("dropdown--active");
    elements.dropdownClick.classList.toggle("dropdownClick--active");
});
